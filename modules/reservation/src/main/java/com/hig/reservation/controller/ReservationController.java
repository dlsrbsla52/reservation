package com.hig.reservation.controller;
...
public class ReservationController {
    ...
    public com.hig.web.response.DataView<List<Object>> getMyReservations(
        @RequestHeader("X-User-Id") String userId
    ) {
        // TODO: 예약 목록 조회 로직 구현
        return com.hig.web.response.DataView.<List<Object>>builder()
                .result(CommonResult.SUCCESS)
                .data(List.of())
                .build();
    }
