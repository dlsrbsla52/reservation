...
import com.media.bus.iam.client.reservation.ReservationApi
import com.media.bus.iam.client.stop.StopApi
import org.springframework.beans.factory.annotation.Value
import org.springframework.context.annotation.Bean
import org.springframework.context.annotation.Configuration

/**
 * iam 모듈의 외부 서비스 클라이언트 프록시 Bean 등록.
 *
 * 설계 의도:
...
class ServiceClientConfig {
    ...
    @Bean
    fun reservationApi(
        @Value("\${services.reservation.url}") reservationServiceUrl: String,
        s2sRestClientFactory: S2SRestClientFactory,
    ): ReservationApi = s2sRestClientFactory.createProxy(reservationServiceUrl, ReservationApi::class.java)
}
